...
store/access raw material, formula, and regulatory data types. Then create simple file
manager package to allow the user peruse, open and view files along with a unit testing
system.
